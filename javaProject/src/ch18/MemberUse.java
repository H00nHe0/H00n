...
public class MemberUse {
	public static void main(String[] args) {
		...
		MemberDTO m2 = new MemberDTO("lee", "이길동", "12345", 20, "lee@gmail.com");
		MemberDTO m3 = new MemberDTO("park", "박길동", "12346", 40, "park@gmail.com");
		try {
			...
			System.out.println("객체를 파일로 저장 했습니다.");
		} catch (Exception e) {
			e.printStackTrace();
		}
