...
public class SwingFileIO extends JFrame implements ActionListener {
	...
	public void setDesign() {
		...
		pTop.add(btnSave);
		pTop.add(btnLoad);
		this.add("North", pTop);//보더 레이아웃의 North영역에 패널 배치
		
		ta = new JTextArea();
		JScrollPane sp = new JScrollPane(ta);
		this.add("Center", sp);//Center 영역에 textarea관련 패널 배치

		btnSave.addActionListener(this);
		btnLoad.addActionListener(this);//이벤트 처리
	}
