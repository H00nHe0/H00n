...
//배열의 단점 - 사이즈 조절이 안됨. 삽입,삭제가 어려움, 다양한 자료형 저장할 수 없음.
//Map계열 - 순서는 제공되지 않지만 키가 제공 됨(인덱스가 없고 키로 조회)
...
public class VectorExam {
	public static void main(String[] args) {
		...
		v.add(106);
		v.add(107);
		//입력된 데이터가 벡터가 만들어 놓은 초기 사이즈(10개)를 넘어가면,
		//10개의 사이즈를 추가로 만든다.
		System.out.println("중간 사이즈 : "+v.capacity());
		//입력된 데이터 사이즈 확인 => 벡터.size() /참고로 배열은 length를 사용
