...
public class FontExam extends JApplet{
	private Font font;
	private FontMetrics fm;//글꼴관련정보를 제공하는 클래스
	private int x,y;
	private String message;
	private Dimension dim;//특정 영역의 사각형의 폭과 높이값을 관리할 수 있도록 도와준다. 
	...
	public void init() {
		...
		System.out.println(dim.width); //전체화면의 가로사이즈
		System.out.println(dim.height); //전체화면의 세로사이즈
