...
public class EventEx2 extends JFrame{
	...
	//버튼을 누르면 MyColorAction에서 구현한 actionPerformed()가 자동 호츌된다.
	//버튼에 이벤트 기능 추가
	button1.addActionListener(new MyColorAction(this, Color.red));
	//이벤트 핸들러를 외부클래스 생성 및 호출을 통해서 구현
	//this는 MyEvent 자신의 객체를 가리키는 것. 또한 데이터 타입으로는 JFrame이 된다.(JFrame을 상속받았기 때문)
